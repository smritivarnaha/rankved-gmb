  ...
  try {
    const location = await prisma.location.findUnique({
      ...
      select: {
        ...
        autoReplyBrandName: true,
        autoReplyKeywords: true,
        autoReplyStrictKeywords: true,
  ...
  try {
    ...
    const updated = await prisma.location.update({
      ...
      data: {
        ...
        autoReplyMode: body.autoReplyMode !== undefined ? body.autoReplyMode : undefined,
        autoReplyMinDelayMinutes: body.autoReplyMinDelayMinutes !== undefined ? parseInt(body.autoReplyMinDelayMinutes, 10) : undefined,
        autoReplyMaxDelayMinutes: body.autoReplyMaxDelayMinutes !== undefined ? parseInt(body.autoReplyMaxDelayMinutes, 10) : undefined,
        autoReplyBrandName: body.autoReplyBrandName !== undefined ? body.autoReplyBrandName : undefined,
        autoReplyKeywords: body.autoReplyKeywords !== undefined ? body.autoReplyKeywords : undefined,
        autoReplyStrictKeywords: body.autoReplyStrictKeywords !== undefined ? Boolean(body.autoReplyStrictKeywords) : undefined,
