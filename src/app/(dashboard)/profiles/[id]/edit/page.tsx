    ...
    <div style={{ maxWidth: 800 }}>
      ...
      {message && (
        <div style={{
          ...
          {message.type === "success" ? <CheckCircle2 size={16} /> : <Loader2 size={16} className="animate-spin" />}
          {message.text}
        </div>
      )}

      <div className="card" style={{ background: "#fff", border: "1px solid #e2e8f0", borderRadius: 12, overflow: "hidden" }}>
          ...
          <form onSubmit={handleSave} style={{ display: "flex", flexDirection: "column", gap: 20 }}>
            ...
            <div>
              ...
              <div style={{ display: "flex", gap: 16, alignItems: "center" }}>
                ...
                <div>
                  <label style={{ background: "#fff", color: "#2563eb", border: "1px solid #bfdbfe", padding: "6px 12px", fontSize: 12, cursor: "pointer", borderRadius: 6, fontWeight: 600 }}>
                    Upload Image
            ...
            <div>
              ...
              <input
                ...
                style={{ width: "100%", padding: "8px 12px", border: "1px solid #e2e8f0", borderRadius: 8, outline: "none" }}
                required
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                style={{ width: "100%", height: 120, padding: "8px 12px", border: "1px solid #e2e8f0", borderRadius: 8, outline: "none", resize: "vertical" }}
            ...
            <div style={{ marginTop: 12, paddingTop: 20, borderTop: "1px solid #f3f4f6", display: "flex", justifyContent: "flex-end" }}>
              <button type="submit" disabled={saving} style={{ padding: "10px 24px", background: "#2563eb", color: "#fff", border: "none", borderRadius: 8, fontWeight: 600, cursor: "pointer", display: "flex", alignItems: "center", gap: 8 }}>
