...
export function AiBulkGenerationModal({ 
  ...
  const CTA_OPTIONS = [
    { value: "AI_DEFAULT", label: "AI selects"  },
  ...
  const URL_REQUIRED = ["BOOK", "ORDER", "BUY", "LEARN_MORE", "SIGN_UP", "GET_OFFER"];
          ...
          {step === 2 && (
            <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
              ...
              <p style={{ fontSize: 12, color: "#6b7280", lineHeight: 1.5 }}>
                Enter one keyword per row — the AI will write the entire post around it. Paste comma-separated keywords to fill multiple rows instantly.
              </p>
              ...
              <div style={{
                ...
                <span style={{ fontSize: 11, fontWeight: 700, color: "#374151", whiteSpace: "nowrap" }}>Apply CTA to all rows:</span>
                <select
                  value={applyAllCta}
                  onChange={e => setApplyAllCta(e.target.value)}
                  style={{ padding: "5px 8px", borderRadius: 6, border: "1px solid #d1d5db", fontSize: 12, color: "#374151", background: "#fff" }}
                >
                ...
                {URL_REQUIRED.includes(applyAllCta) && (
                  <input
                    ...
                    style={{ flex: 1, minWidth: 140, padding: "5px 10px", borderRadius: 6, border: "1px solid #d1d5db", fontSize: 12 }}
                  />
                )}
                <button
                  onClick={applyToAll}
                  style={{
                    padding: "5px 14px", borderRadius: 6, background: "#111827",
              ...
              {/* Table header */}
              <div style={{
                display: "grid", gridTemplateColumns: "68px 1fr 120px 130px",
                gap: 8, padding: "6px 10px",
                background: "#f3f4f6", borderRadius: 6,
              }}>
                {["Date", "Keyword", "CTA Button", "URL"].map(h => (
                    ...
                    >
                      ...
                      <input
                        ...
                        style={{
                          ...
                          border: `1px solid ${!kw.trim() ? "#fca5a5" : "#e5e7eb"}`,
                          background: !kw.trim() ? "#fff5f5" : "#fff",
                          outline: "none",
                        }}
                      />
                      ...
                      <select
                        ...
                        onChange={e => {
                          const next = [...ctas];
                          next[idx] = { type: e.target.value, url: "" };
                          setCtas(next);
                        }}
                        style={{
                          padding: "6px 6px", borderRadius: 6, fontSize: 11,
                          border: "1px solid #e5e7eb", background: "#fff",
                          color: rowCta.type === "AI_DEFAULT" ? "#9ca3af" : "#111827",
                        }}
                      >
                        {CTA_OPTIONS.map(o => <option key={o.value} value={o.value}>{o.label}</option>)}
                      </select>

                      {/* URL field or placeholder */}
                      {needsUrl ? (
                        <input
                          type="url"
                          placeholder="https://"
