...
import { 
  ...
  Calendar, Zap, Sparkles, LayoutDashboard
} from "lucide-react";
...
export function PerformanceView({ data, profile }: any) {
  ...
  return (
    <div className="anim-fade-up">
      ...
      <div className="flex items-center gap-3 mb-12 bg-white/50 backdrop-blur-xl p-2 rounded-[24px] border border-neutral-100 w-max shadow-xl shadow-neutral-100/50">
        <button 
          ...
          <div className="bg-white rounded-[48px] border border-neutral-100 p-12 shadow-2xl shadow-neutral-100/50 relative overflow-hidden group">
            ...
            <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between mb-12 gap-8">
              <div>
                ...
                <p className="text-neutral-400 font-medium text-lg">Daily business interaction trends for the current period.</p>
              </div>
